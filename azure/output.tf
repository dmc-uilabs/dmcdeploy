...
output "domePubIp.ip" {
  value = "${azurerm_public_ip.platformdomePubIp.ip_address}"
}
output "domeplatformSSH" {
  value = "cd ${var.sshKeyPath} && ssh -i '${var.sshKeyFilePri}' ${var.dmcUser}@${azurerm_public_ip.platformdomePubIp.ip_address}"
}

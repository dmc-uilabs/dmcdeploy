...
provisioner "remote-exec" {
       inline = [
        ...
        "echo export VAL_S3_KEY=${var.validate_s3_key} | sudo tee -a /etc/profile.d/dmc.sh",
        "echo export VAL_S3_SECRET=${var.validate_s3_secret} | sudo tee -a /etc/profile.d/dmc.sh",
        "echo export SENDGRID_API_KEY=${var.sendGrid_api} | sudo tee -a /etc/profile.d/dmc.sh",

...
provisioner "remote-exec" {
       inline = [
        ...
        "echo export VAL_S3_KEY='' | sudo tee -a /etc/profile.d/dmc.sh",
        "echo export VAL_S3_SECRET='' | sudo tee -a /etc/profile.d/dmc.sh",
        "echo export SENDGRID_API_KEY='' | sudo tee -a /etc/profile.d/dmc.sh",

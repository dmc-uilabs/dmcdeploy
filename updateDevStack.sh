...
key_location=~/keys/DMCDriver.pem


export front_ssh_key=${key_location}
...
export front_deploy_commit=""
export serverURL=""


export rest_ssh_key=${key_location}
...
export rest_deploy_commit=""
export use_swagger=1


export db_ssh_key=${key_location}
...
export solr_ssh_key=${key_location}
